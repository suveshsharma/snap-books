...
<body>
<div class="front">
<h1 class="one">Add Books</h1>
<hr size="4">
<div class="inner">
<form action="bookregister" method="get">
	<h2>Book Title: <input type="text" name="btitle"></h2> <br> <br>
	<h2>Book Language: <input type="text" name="blanguage"></h2> <br> <br>
	<h2>Book Author: <input type="text" name="bauthor"></h2> <br> <br>
	<h2>Book Available: <input type="text" name="bavailable"></h2> <br> <br>
	<input type="submit"> &nbsp; &nbsp;
	<input type="reset">
	</form>
</div>
